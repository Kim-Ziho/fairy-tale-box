...
function spawnTest(wordname, hist_num) {
  return new Promise(function (resolve, reject) {
    ...
    const command = `cp -r C://Users/multicampus/Desktop/S08P12C101/backend/talebox_nodejs/backend/example/recond C://Users/multicampus/Desktop/S08P12C101/backend/talebox_nodejs/backend/example/${wordname}${hist_num} \n`; // a: 숨긴 파일까지 , l: 자세한 내용까지 검색
